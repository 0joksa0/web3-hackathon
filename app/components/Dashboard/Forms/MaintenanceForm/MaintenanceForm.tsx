...
interface MaintenanceFormProps {
    onSubmit: (part: string, hash: string, note: string, mileage : string) => void;
    onCancel?: () => void;
    disabled?: boolean;
}
...
export function MaintenanceForm({ onSubmit, onCancel, disabled }: MaintenanceFormProps) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            onSubmit(part, IpfsHash, note, mileage);
        } catch (e: any) {
    ...
    return (
        <div className="space-y-4">
            ...
            <input
                ...
                className="w-full bg-[#111]/50 px-3 py-2 rounded-lg text-white placeholder-gray-400"
            />
